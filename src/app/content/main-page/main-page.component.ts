...
export class MainPageComponent implements OnInit {
  ...
  tiles: ITile[] = [
    {route: '#', picUrl: "../../assets/images/gridPics/grid-1-web.png", cols: 4, rows: 1, alt: 'Теплые полы в Минске'},
    ...
    {route: '/warmehaus/films', picUrl: "../../assets/images/gridPics/Инфракрасная_Плёнка.png", cols: 2, rows: 1, alt: 'Инфракрасная пленка'},
